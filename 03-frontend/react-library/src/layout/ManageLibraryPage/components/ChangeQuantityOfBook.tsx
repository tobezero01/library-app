...
export const ChangeQuantityOfBook: React.FC<{ book: BookModel, deleteBook: any }> = (props, key) => {
    ...
    useEffect(() => {
        const fetchBookInState = () => {
            ...
            props.book.copies ? setQuantity(parseInt(props.book.copies)) : setQuantity(0);
            props.book.copiesAvailable ? setRemaining(parseInt(props.book.copiesAvailable)) : setRemaining(0);
        };
        fetchBookInState();
    }, []);
